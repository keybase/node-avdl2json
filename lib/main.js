...
(function() {
  var FileRunner, Main, Parser, Stack, astmod, colors, fs, iced, make_esc, minimist, parse, pathmod, usage, __iced_k, __iced_k_noop;
  ...
  exports.FileRunner = FileRunner = (function() {
    function FileRunner(_arg) {
      this.infile = _arg.infile, this.stack = _arg.stack, this.dir = _arg.dir;
...
_break()
  ...
  exports.Main = Main = (function() {
    ...
    Main.prototype.output = function(_arg, cb) {
      var ast, err, json, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      ast = _arg.ast;
      json = ast.to_json();
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            parent: ___iced_passed_deferral,
            filename: "/Users/max/src/keybase/node-avdl2json/src/main.iced",
            funcname: "Main.output"
          });
          fs.writeFile(_this.outfile, JSON.stringify(json, null, 2), __iced_deferrals.defer({
            assign_fn: (function() {
              return function() {
