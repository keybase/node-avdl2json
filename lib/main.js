...
(function() {
  ...
  exports.FileRunner = FileRunner = (function() {
    function FileRunner(_arg) {
      this.infile = _arg.infile, this.stack = _arg.stack, this.dir = _arg.dir, this.version = _arg.version, this.rewriter = _arg.rewriter;
      this.rewriter || (this.rewriter = function(x) {
        return x;
      });
        ...
        return (function(__iced_k) {
          ...
          _while = function(__iced_k) {
            ...
            if (!(_i < _len)) {
              ...
              i = _ref[_i];
              (function(__iced_k) {
                if (_this.stack.lookup((nm = _this.rewriter(i.get_path_string({
...
_break()
  ...
  exports.parse = parse = function(_arg, cb) {
    var ast, err, infile, p, rewriter, version, ___iced_passed_deferral, __iced_deferrals, __iced_k;
    __iced_k = __iced_k_noop;
    ___iced_passed_deferral = iced.findDeferral(arguments);
    infile = _arg.infile, version = _arg.version, rewriter = _arg.rewriter;
