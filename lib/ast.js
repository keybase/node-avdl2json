...
(function() {
  var ArrayType, ArrayValue, Decorator, Decorators, Doc, Enum, Field, Fixed, Identifier, Import, MapType, Message, Node, Param, Protocol, Record, String, Type, Union, Value,
  ...
  Protocol = (function(_super) {
    ...
    Protocol.prototype.has_messages = function() {
    ...
    Protocol.prototype.get_all_protocols = function(seen) {
