...
(function() {
  var ArrayType, ArrayValue, Decorator, Decorators, Doc, Enum, Field, Fixed, Identifier, Import, MapType, Message, Node, Param, Protocol, ProtocolBase, ProtocolV2, Record, String, Type, TypeBase, TypeV2, Union, Value,
  ...
  Message = (function(_super) {
    ...
    function Message(_arg) {
      var decorators, end, start;
      start = _arg.start, end = _arg.end, decorators = _arg.decorators, this.name = _arg.name, this.params = _arg.params, this.return_type = _arg.return_type, this.one_way = _arg.one_way;
