...
(function() {
  var ArrayType, ArrayValue, Case, CaseBody, CaseLabel, Decorator, Decorators, Doc, Enum, Field, Fixed, Identifier, Import, MapType, Message, Node, Param, Protocol, ProtocolBase, ProtocolV2, Record, String, Switch, Type, TypeBase, TypeV2, Union, Value, Variant, VoidCaseBody,
  ...
  CaseLabel = (function(_super) {
    ...
    CaseLabel.prototype.to_json = function() {
      var _ref;
      return {
        name: ((_ref = this.name) != null ? _ref.to_json() : void 0) || null,
        def: this.def
      };
    };
  ...
  VoidCaseBody = (function(_super) {
    __extends(VoidCaseBody, _super);

    function VoidCaseBody(_arg) {
      var end, start;
      start = _arg.start, end = _arg.end;
      VoidCaseBody.__super__.constructor.call(this, {
        start: start,
        end: end
      });
    }

    VoidCaseBody.prototype.to_json = function() {
      return {
        "void": "true"
      };
    };
